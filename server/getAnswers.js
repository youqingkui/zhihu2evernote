...
(function() {
  var Evernote, GetAnswer, SyncLog, Task, async, cheerio, crypto, makeNote, q, request, saveErr;
  ...
  q = async.queue(function(data, cb) {
    ...
    return async.series([
      function(callback) {
        return g.changeStatus(callback);
      }, function(callback) {
  ...
  GetAnswer = (function() {
    ...
    GetAnswer.prototype.changeStatus = function(cb) {
      var self;
      self = this;
      return Task.findOne({
        url: self.url,
    ...
    GetAnswer.prototype.saveLog = function(cb) {
      var logs;
      logs = new SyncLog();
