...
(function() {
  var Evernote, async, changeImg, cheerio, cookie, crypto, encodeImg, fs, getImgRes, makeNote, mime, noteStore, op, pageImport, reqOp, request, rmAttr;
  ...
  pageImport(op, function(err, result) {
    if (err) {
      return console.log(err);
    }
    return console.log("hello ok?");
  });
